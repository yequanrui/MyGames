...
function clickTile(tile) {
  if (tile.classList.contains('tile--checked') || tile.classList.contains('tile--flagged') || tile.classList.contains('flipped')) return;
...
function checkFlagVictory() {
  ...
  for (let tile of tiles) {
    let coordinate = tile.getAttribute('data-id');
    if (tile.classList.contains('tile--flagged') && bombs.includes(coordinate)) {
      cnt++;
    }
  }
